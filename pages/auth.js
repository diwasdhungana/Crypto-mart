...
<Container className={classes.container}>
     <Paper elevation={4} className={classes.auth_container}>
        <Grid>
          ...
          <Typography variant='h1'>Connect with one of our available wallet providers or create a new one.</Typography>
            ...
            <button onClick={authenticate} className={classes.connect}>Connect with Metamask</button>
    {metamask.map(item => (
              <Card>      
                  <CardMedia
                      component="img"

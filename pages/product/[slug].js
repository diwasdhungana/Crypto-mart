  ...
  return (
    ...
    <Paper className={classes.product_container} elevation={4}>
      ...
      <Grid container spacing={1}>
        ...
        <Grid item xs={12} sm={6} md={4}>
          <List>
            ...
            <ListItem>
                <Typography component="h2" variant="h2"> Price: </Typography>
            ...
            <ListItem>
              ...
              <Typography component="h4" variant="h4">{product.category}</Typography>
            </ListItem>
          </List>
        </Grid>
      </Grid>
      ...
      <div className={classes.product_details}>
        ...
        <Typography component="h4" variant="h4">{product.description.long}</Typography>
      </div>
      </Paper>
